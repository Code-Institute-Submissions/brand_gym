<h1 align="center">
  ...
  It is responsive and viewable on multiple devices. The design might appear a little unorthodox at first but through this, the site is becoming intuitive and easy to navigate. It's for members and potential clients.
...
- User stories
  ...
  - First Time Visitor Goals
      ...
      3. As a first time visitor, I want to be able to navigate easily through all the different sections/pages without any complications as simple as possible. Also, I want to have more than one option to navigate.
      4. As a first time visitor, I want to be able to get all the information (like services, courses, etc) as short and understandable as possible
      5. As a first time visitor, I want to be able to see all important contact details (like phone number, email or address) and easily get in touch with the team for eventual questions (contact section/page).
      6. As a first time visitor, I want to be able to take a short cut straight to the member section/page (main purpose) and have as few steps/clicks as possible for buying one of the membership.
  ...
  - Returning Visitor Goals
      ...
      4. As a returning visitor, I want to book a service of my choice.
      5. As a returning visitor, I might want to rethink my decision if I didn't get/buy a membership. 

  - Frequent User Goals
      1. As a frequent user, I want to quickly check if the gym schedule changed or got optimized (I want to stay up to date).
      2. As a frequent user, I want to be informed about any new courses, services or events (general changes/updates)
      3. As a frequent user, I want to be motivated to use the full spectrum of the site - i.e. by downloading the app (or other services - updates might come as well).
      4. As a frequent user, I want to be comfortable and able to use the booking service.
      5. As a frequent user, I want to be able to contact the gym as uncomplicated and easy as possible.
      6. As a frequent user, I want to be able to sign up - for having more benefits (coming soon).
...
- Design
  ...
  - Color Scheme
    ...
    - The sidebar and the footer are consistent and have always the same color schemes while every section/page has it's own.
    - A dark-colored scheme got chosen for the footer/sidebar for better optical separation and less distraction from the main content.
